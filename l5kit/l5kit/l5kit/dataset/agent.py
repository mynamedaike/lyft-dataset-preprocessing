...
#        start_index = self.dataset.frames[frame_interval[0]]["agent_index_interval"][0]
        start_index = np.squeeze(self.dataset.frames[frame_interval[0]]["agent_index_interval"])[0]
#        end_index = self.dataset.frames[frame_interval[1] - 1]["agent_index_interval"][1]
        end_index = np.squeeze(self.dataset.frames[frame_interval[1] - 1]["agent_index_interval"])[1]
